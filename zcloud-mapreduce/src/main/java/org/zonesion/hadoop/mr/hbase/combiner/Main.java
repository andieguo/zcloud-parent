...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setMapperClass(PMMapper.class);// 指定Mapper
		job.setCombinerClass(PMCombiner.class);// 指定Combiner
		TableMapReduceUtil.initTableReducerJob(tablename, PMReduce.class, job);// 指定Reducer
