...
<head>
    ...
    <script>
    	...
    	function on_get_volume(err, d) {
            ...
            var url = 'http://192.168.100.10:8080/client/api?command=listVirtualMachines&details=all&account=admin&response=json';
            window.rest.get(url, "on_get_virtualmachine");
    	}
        ...
        $(function(){
            ...
            on_get_zone(null, z);
            var url = 'http://192.168.100.10:8080/client/api?command=listZones&showcapacities=true&response=json';
            getRest(url, function(errortag,data){on_get_zone(errortag,data);});
            ...
            //var url = 'http://192.168.100.10:8080/client/api?command=listClusters&showcapacities=true&response=json';
            //window.rest.get(url, "on_get_cluster");
            ...
            on_get_host(null, h);
            //var url = 'http://192.168.100.10:8080/client/api?command=listHosts&details=capacity&response=json';
            //window.rest.get(url, "on_get_host");
            ...
            //var url = 'http://192.168.100.10:8080/client/api?command=listVolumes&account=admin&response=json';
            //window.rest.get(url, "on_get_volume");
        });
