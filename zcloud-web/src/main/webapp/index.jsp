...
<head>
    ...
    <script>
    	...
    	function on_get_volume(err, d) {
         ...
         getRest(url, function(errortag,data){on_get_virtualmachine(errortag,data);});
    	}
        ...
        //////////////////////  以下为测试代瞿 ///////////////////////////////////
        $(function(){
    		  var tr ="<tr><td><img src='images/Loading.gif'/></td></tr>";    
            $("#tab_zone").append(tr);
            ...
            getRest(url, function(errortag,data){on_get_cluster(errortag,data);});
            ...
            getRest(url, function(errortag,data){on_get_host(errortag,data);});
            ...
            getRest(url, function(errortag,data){on_get_volume(errortag,data);});
